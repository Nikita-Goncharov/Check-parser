...
if __name__ == "__main__":
    # Code for testing
    checks_count = 0
    check_folder = "lotto"  # "/home/nikita-goncharov/Desktop/Failed_checks"  # checks directory
    ...
    for file in checks_list:
        ...
        if os.path.isfile(item_path):
            ...
            check_data, all_not_found, not_found_data, check_logs = item_file.get_result()
